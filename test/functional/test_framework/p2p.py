...
MAGIC_BYTES = {
    "mainnet": b"\xf9\xbc\xb4\xd2",   # UniversalMolecule mainnet
    "testnet3": b"\x0b\x11\x09\x08",  # UniversalMolecule testnet
    "regtest": b"\xfa\xbf\xb5\xda",   # UniversalMolecule regtest
    "signet": b"\x54\xd2\x6f\xbd",    # UniversalMolecule signet
}

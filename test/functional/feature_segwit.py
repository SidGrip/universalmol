...
# Keep enough pre-activation mature coinbase outputs for UniversalMolecule's
# funding-heavy SegWit checks. The original upstream value left this test one
# or more UMO UTXOs short under the UniversalMolecule regtest maturity/subsidy

...
class WalletTaprootTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # UniversalMolecule regtest uses the historical 120-block maturity.
        # Mine the shared Taproot wallet funding depth so the funding wallet has
        # spendable outputs before the Taproot spend loop.

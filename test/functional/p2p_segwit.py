...
UMO_REGTEST_POW_LIMIT_BITS = "207fffff"
UMO_REGTEST_TARGET_SPACING = 2 * 60
...
class SegWitTest(BitcoinTestFramework):
    ...
    def build_next_block(self):
        ...
        if tip_header["bits"] != UMO_REGTEST_POW_LIMIT_BITS:
            block_time = max(block_time, tip_header["time"] + 2 * UMO_REGTEST_TARGET_SPACING + 1)

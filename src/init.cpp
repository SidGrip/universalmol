...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BlueDragon747/universalmol>";
    const std::string URL_WEBSITE = "<https://github.com/BlueDragon747/universalmol>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("UniversalMolecule version %s\n", FormatFullVersion());
}

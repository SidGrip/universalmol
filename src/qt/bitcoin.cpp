...
static const char* qt_argv = "universalmolecule-qt";
...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if(success) {
        ...
        // universalmolecule: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    /// 6-7. Parse universalmolecule.conf, determine network, switch to network specific
    ...
    // universalmolecule: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {

...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("universalmolecule://", Qt::CaseInsensitive))
    {
        uri.replace(0, 20, "universalmolecule:");
    }
...
{
    QString ret = QString("universalmolecule:%1").arg(info.address);
    int paramCount = 0;
...
fs::path static StartupShortcutPath()
{
    ...
    return GetSpecialFolderPath(CSIDL_STARTUP) / strprintf("UniversalMolecule (%s).lnk", chain);
}

...
#if defined(NDEBUG)
# error "UniversalMolecule cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "UniversalMolecule Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck = false)
{
    ...
    // UniversalMolecule's legacy 0.8 chain intentionally only enforced the BIP30
    // overwrite check for CreateNewBlock-style contexts (where pindex has no
    // hash yet). Preserve that relaxed rule here so historical UniversalMolecule
    // replay does not reintroduce a broader Bitcoin-style duplicate-txid reject.
    //
...
static bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, const CChainParams& params, const CBlockIndex* pindexPrev, int64_t nAdjustedTime, bool fCheckPOW = true)
{
    ...
    // UniversalMolecule historical data carries AuxPoW data before the nominal

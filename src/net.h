...
private:
    ...
    // UniversalMolecule removed upstream `mutable CHash256 hasher;` and uses
    // 8-round BLAKE-256 for P2P message checksums, not double SHA-256.
    ...
    void Reset() {
        ...
        nDataPos = 0;
        data_hash.SetNull();
        // No streaming hasher to reset; UniversalMolecule computes

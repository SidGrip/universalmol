...
int V1TransportDeserializer::readData(Span<const uint8_t> msg_bytes)
{
    ...
    // UniversalMolecule has no streaming hasher update. It computes the
...
const uint256& V1TransportDeserializer::GetMessageHash() const
{
    assert(Complete());
    if (data_hash.IsNull()) {
        // UniversalMolecule P2P wire-message checksum is 8-round BLAKE-256
...
{
    // UniversalMolecule P2P outgoing-message checksum is 8-round BLAKE-256

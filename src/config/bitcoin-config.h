...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The UniversalMolecule Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "UniversalMolecule Core"
...
#define PACKAGE_BUGREPORT "https://github.com/BlueDragon747/universalmol/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "UniversalMolecule Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "UniversalMolecule Core 0.15.21"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "universalmolecule"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://github.com/BlueDragon747/universalmol"

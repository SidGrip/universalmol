...
const char * const BITCOIN_CONF_FILENAME = "universalmolecule.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\UniversalMolecule
    // macOS: ~/Library/Application Support/UniversalMolecule
    // Unix-like: ~/.universalmolecule
#ifdef WIN32
    // Windows
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/UniversalMolecule";
#else
    // Unix-like

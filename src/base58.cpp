...
std::string EncodeBase58Check(Span<const unsigned char> input)
{
    ...
    // UniversalMolecule Base58Check checksum uses 8-round BLAKE-256, not
    // upstream double-SHA-256. This keeps UniversalMolecule addresses from
    // validating under upstream-standard decoders, and vice versa.
...
[[nodiscard]] static bool DecodeBase58Check(const char* psz, std::vector<unsigned char>& vchRet, int max_ret_len)
{
    ...
    // Symmetric with EncodeBase58Check: Base58Check checksum

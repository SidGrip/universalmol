    ...
    : TestingSetup{CBaseChainParams::REGTEST, extra_args, coins_db_in_memory, block_tree_db_in_memory}
{
...

    {
        ...
        // UniversalMolecule regtest deterministic 100-block-chain tip hash. The donor
        // The donor tree had its own tip hash here; switching to UniversalMolecule
        // regtest's distinct genesis produces a different chain.
        if (tip_hash != "32c38b1663753cad4a98259a3cdc482322d6608df8117969871da2c6fb6d7b1b") {

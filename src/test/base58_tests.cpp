...
BOOST_AUTO_TEST_CASE(base58_DecodeBase58)
{
    ...
    // UniversalMolecule uses a different Base58Check checksum than upstream, so avoid
    // hard-coding the upstream canonical checksum string here. Test the checksum

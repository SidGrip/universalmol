...
uint256 static SignatureHashOld(CScript scriptCode, const CTransaction& txTo, unsigned int nIn, int nHashType)
{
    ...
    ss << txTmp << nHashType;
    // UniversalMolecule legacy pre-SegWit sighash is single SHA-256. Witness-v0 keeps
...
// against a local UniversalMolecule reference implementation rather than upstream

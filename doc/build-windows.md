...
Below are some notes on how to build UniversalMolecule Core for Windows.
...
way. This will install to `c:\workspace\universalmolecule`, for example:

    make install DESTDIR=/mnt/c/workspace/universalmolecule

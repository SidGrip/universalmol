...
(
    ...
    (
        ...
        # copy over the example universalmolecule.conf file. if contrib/devtools/gen-universalmolecule-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/universalmolecule.conf" "${DISTNAME}/"
